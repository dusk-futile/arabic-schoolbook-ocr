...
from eval.metrics import boundary_scores, cer, wer
...
def main():
    ...
    ap.add_argument("--synth", default="eval/synth")
    args = ap.parse_args()
    rows = []
    ...
    json.dump(rows, open("eval/results_structure.json", "w"), indent=1)
    print("\nwrote eval/results_structure.json")
